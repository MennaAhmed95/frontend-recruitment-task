...
import { CLIP_START } from '@/utils/timelineLayout'
...
export function Timeline() {
  ...
  const splitSelected = useTimelineStore((s) => s.actions.splitSelectedClipAtMidpoint)
    ...
    <div className="border-t border-slate-200">
      ...
      <div className="border-t border-slate-200">
        <div className="relative overflow-auto">
          ...
          {/* click-to-seek overlay – only over clip area, 0s at left edge */}
          <div
            className="absolute inset-y-0 right-0 cursor-crosshair"
            style={{ left: CLIP_START }}
            onMouseDown={(e) => {
